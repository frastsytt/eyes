...
def get_param_rss_feed(keyword):
    try:
        ...
        output = subprocess.check_output(search_pattern, shell=True, stderr=subprocess.DEVNULL)
        ...
        search_results = NewsStory.query.order_by(NewsStory.submission_date.desc()).limit(20).all()
