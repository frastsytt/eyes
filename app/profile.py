...
from flask import request, Blueprint, redirect, url_for, session, jsonify, render_template, g, render_template_string
...
def profile():
    ...
    if request.method == 'GET':
        ...
        return render_template('profile.html', username=username, admin_role=user_role, title="Profile", userinfo=return_user, user_email=email)
